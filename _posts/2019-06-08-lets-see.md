...
{% include image.html url="/assets/img/autoencoder.png" description="" %} <br/>


You can see in above image that x is our real distribution and q(z|x) is our encoder, $z\simq(z)$ is a sample taken from q(z), and from this distribution, we make a similar distribution.<br/>
