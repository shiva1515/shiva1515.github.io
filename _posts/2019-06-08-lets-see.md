...
def sample(model,n_batch, max_len=100):
    ...
    return samples
```
I hope you like it.If you have any doubts Let us know in the comments.
What kinds of content would you like to see more on this blog?
Refrences
<a href="https://www.youtube.com/channel/UCP9YJJ24w6g38VMVMm6Thtg" target="_blank">alhad kumar</a><br/> video explanation and git hub code <a href="https://github.com/molecularsets/moses/tree/master/moses/aae" target="_blank">moses</a><br/>
